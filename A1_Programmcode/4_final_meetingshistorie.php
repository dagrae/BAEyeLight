...
<head>
    ...
    <title>EyeLight - Meetingshistorie</title>
    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
        <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="0_final_startseite.php">
            ...
            <ul class="navbar-nav text-light" id="accordionSidebar">
                ...
                <li class="nav-item"><a class="nav-link active" href="4_final_meetingshistorie.php"><i class="la la-reorder"></i><span>Meetingshistorie</span></a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col">
                        ...
                        <p style="margin-bottom: 20px;margin-top: 10px;">Historie mit Rahmendaten der zuletzt durchgeführten Meetings. Zum löschen der gesamten Historie steht Ihnen der Button "Historie löschen" zur Verfügung.</p>
                    </div>
                </div>
                <div class="card shadow">
                    <div class="card-header py-3">
                        <p class="text-primary m-0 fw-bold">Meetingshistorie</p>
                    </div>
                    <div class="card-body">
                        <div id="dataTable-2" class="table mt-2" role="grid" aria-describedby="dataTable_info">
                            <table class="table my-0" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th style="width: 15%;">Teilnehmer vor Ort</th>
                                ...
                                $abfrage = $db->query("SELECT * FROM historie_meeting ORDER BY id DESC");
                                ...
                                while ($ausgabe = $abfrage->fetch_object())
                                {
                                    echo ' 
                                            ...
                                            <td>' . $ausgabe->ende . '</td>
                                              <td>' . $ausgabe->name . '</td>
                                            <td>' . $ausgabe->teilnehmer . '</td>
                                            <td>' . $ausgabe->dauer . ' Min.</td>
                                            </tr>                                          
                                            ';
                                }
                                ?>
                        ...
                        <form>
                            <div class="text-end form-group mb-3" style="padding-top: 30px;">
                                <input class="btn btn-primary btn-sm" input type="submit" name="löschen" formaction="meetings_löschen.php" value="Historie löschen" style="background: var(--bs-danger);color: rgb(255, 255, 255);border-color: transparent;">
                            </div>
                        </form>
                    </div>
                </div>
                    ...
                    <div class="row" style="margin: 0px;">
                        <div class="col">
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select" name="preset" id="presets" onchange="showPreset(this.value)">
                                    <?php // laden der Presets aus der DB
                                    $db = new mysqli("localhost:3306", "root", "root", "EyeLight");
